...
class AdminOrdersTestCase(TestCase):
    ...
    def test_admin_orders_post_method_without_authentication(self):
        response = self.client.post('/orders/1/a/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/index.html')
        self.assertEqual(response.templates[1].name, 'page/base.html')
        self.assertEqual(len(response.redirect_chain), 1)
        self.assertEqual(response.redirect_chain[0][0], '/?next=/orders/1/a/')
    ...
    def test_admin_orders_post_method_with_authentication(self):
        self.client.force_login(self.user)
        response = self.client.post('/orders/1/a/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/index.html')
        self.assertEqual(response.templates[1].name, 'page/base.html')
    ...
    def test_admin_orders_post_method_with_authentication_as_druk_group(self):
        self.user.groups.add(self.groups['druk'])
        self.client.force_login(self.user)
        response = self.client.post('/orders/1/a/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/user_orders.html')
    ...
    def test_admin_orders_post_method_with_authentication_as_proper_group(self):
        self.user.groups.add(self.groups['administracja'], self.groups['4dich'])
        self.client.force_login(self.user)
        response = self.client.post('/orders/1/a/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/admin_orders.html')
    ...
    def test_admin_orders_put_method_without_authentication(self):
        response = self.client.put('/orders/1/a/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/index.html')
        self.assertEqual(response.templates[1].name, 'page/base.html')
        self.assertEqual(len(response.redirect_chain), 1)
        self.assertEqual(response.redirect_chain[0][0], '/?next=/orders/1/a/')
    ...
    def test_admin_orders_put_method_with_authentication(self):
        self.client.force_login(self.user)
        response = self.client.put('/orders/1/a/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/index.html')
        self.assertEqual(response.templates[1].name, 'page/base.html')
    ...
    def test_admin_orders_put_method_with_authentication_as_druk_group(self):
        self.user.groups.add(self.groups['druk'])
        self.client.force_login(self.user)
        response = self.client.put('/orders/1/a/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/user_orders.html')
    ...
    def test_admin_orders_put_method_with_authentication_as_proper_group(self):
        self.user.groups.add(self.groups['administracja'], self.groups['4dich'])
        self.client.force_login(self.user)
        response = self.client.put('/orders/1/a/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/admin_orders.html')
    ...
    def test_admin_orders_delete_method_without_authentication(self):
        response = self.client.delete('/orders/1/a/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/index.html')
        self.assertEqual(response.templates[1].name, 'page/base.html')
        self.assertEqual(len(response.redirect_chain), 1)
        self.assertEqual(response.redirect_chain[0][0], '/?next=/orders/1/a/')
    ...
    def test_admin_orders_delete_method_with_authentication(self):
        self.client.force_login(self.user)
        response = self.client.delete('/orders/1/a/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/index.html')
        self.assertEqual(response.templates[1].name, 'page/base.html')
    ...
    def test_admin_orders_delete_method_with_authentication_as_druk_group(self):
        self.user.groups.add(self.groups['druk'])
        self.client.force_login(self.user)
        response = self.client.delete('/orders/1/a/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/user_orders.html')
    ...
    def test_admin_orders_delete_method_with_authentication_as_proper_group(self):
        self.user.groups.add(self.groups['administracja'], self.groups['4dich'])
        self.client.force_login(self.user)
        response = self.client.delete('/orders/1/a/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/admin_orders.html')
