...
class AddNewMessageTestCase(TestCase):
    ...
    def test_get_method_with_authentication_with_wrong_group(self):
        self.user.groups.add(self.groups['administracja'])
        self.client.force_login(self.user)
        response = self.client.get('/message/add_new/', {'reciever': 'besart', 'message_subject': 'subject',
                                                         'message_text': 'text'}, follow=True)
        self.assertEqual(response.request['PATH_INFO'], '/')
        self.assertEqual(len(response.redirect_chain), 3)
        self.assertEqual(response.redirect_chain[0][0], '/inbox/')
    ...
    def test__get_method_with_authentication_with_proper_group(self):
        user = User(username='user2', password='psw')
        user.save()
        user.groups.add(self.groups['druk'])
        self.client.force_login(user)
    ...
    def test_put_method_with_authentication_without_group(self):
        self.client.force_login(self.user)
        response = self.client.put('/message/add_new/', {'reciever': 'besart', 'message_subject': 'subject',
                                                         'message_text': 'text'}, follow=True)
        self.assertEqual(len(response.redirect_chain), 3)
    ...
    def test_put_method_with_authentication_with_wrong_group(self):
        self.user.groups.add(self.groups['administracja'])
        self.client.force_login(self.user)
        response = self.client.put('/message/add_new/', {'reciever': 'besart', 'message_subject': 'subject',
                                                         'message_text': 'text'}, follow=True)
    ...
    def test_put_method_with_authentication_with_proper_group(self):
        user = User(username='user2', password='psw')
        user.save()
        user.groups.add(self.groups['druk'])
        self.client.force_login(user)
        response = self.client.put('/message/add_new/', {'reciever': '1', 'message_subject': 'subject',
                                                         'message_text': 'text'}, follow=True)
        self.assertEqual(response.request['PATH_INFO'], '/inbox/')
        self.assertEqual(len(response.redirect_chain), 1)
        self.assertEqual(response.redirect_chain[0][0], '/inbox/')
        ...
        self.user.groups.add(self.groups['administracja'], self.groups['4dich'])
        self.client.force_login(self.user)
        response = self.client.put('/message/add_new/', {'reciever': '6', 'message_subject': 'subject',
                                                         'message_text': 'text'}, follow=True)
        self.assertEqual(response.request['PATH_INFO'], '/inbox/')
        self.assertEqual(len(response.redirect_chain), 1)
        self.assertEqual(response.redirect_chain[0][0], '/inbox/')
    ...
    def test_delete_method_without_authentication(self):
        response = self.client.delete('/message/add_new/', {'reciever': 'besart', 'message_subject': 'subject',
                                                            'message_text': 'text'}, follow=True)
        self.assertEqual(response.request['PATH_INFO'], '/')
        self.assertEqual(len(response.redirect_chain), 1)
        self.assertEqual(response.redirect_chain[0][0], '/?next=/message/add_new/')
    ...
    def test_delete_method_with_authentication_without_group(self):
        self.client.force_login(self.user)
        response = self.client.delete('/message/add_new/', {'reciever': 'besart', 'message_subject': 'subject',
                                                            'message_text': 'text'}, follow=True)
        self.assertEqual(len(response.redirect_chain), 3)
    ...
    def test_delete_method_with_authentication_with_wrong_group(self):
        self.user.groups.add(self.groups['administracja'])
        self.client.force_login(self.user)
        response = self.client.delete('/message/add_new/', {'reciever': 'besart', 'message_subject': 'subject',
                                                            'message_text': 'text'}, follow=True)
    ...
    def test_delete_method_with_authentication_with_proper_group(self):
        user = User(username='user2', password='psw')
        user.save()
        user.groups.add(self.groups['druk'])
        self.client.force_login(user)
        response = self.client.delete('/message/add_new/', {'reciever': '1', 'message_subject': 'subject',
                                                            'message_text': 'text'}, follow=True)
        self.assertEqual(response.request['PATH_INFO'], '/inbox/')
        self.assertEqual(len(response.redirect_chain), 1)
        self.assertEqual(response.redirect_chain[0][0], '/inbox/')
        ...
        self.user.groups.add(self.groups['administracja'], self.groups['4dich'])
        self.client.force_login(self.user)
        response = self.client.delete('/message/add_new/', {'reciever': '6', 'message_subject': 'subject',
                                                            'message_text': 'text'}, follow=True)
        self.assertEqual(response.request['PATH_INFO'], '/inbox/')
        self.assertEqual(len(response.redirect_chain), 1)
        self.assertEqual(response.redirect_chain[0][0], '/inbox/')
