...
class NewMessageTestCase(TestCase):
    ...
    def test_post_method_with_authentication_as_wrong_group(self):
        self.user.groups.add(self.groups['administracja'])
        self.client.force_login(self.user)
        response = self.client.post('/message/new/', follow=True)
        self.assertEqual(response.request['PATH_INFO'], '/')
    ...
    def test_put_method_without_authentication(self):
        response = self.client.put('/message/new/', follow=True)
        self.assertEqual(response.request['PATH_INFO'], '/')
        self.assertEqual(len(response.redirect_chain), 1)
        self.assertEqual(response.redirect_chain[0][0], '/?next=/message/new/')
        self.assertEqual(response.redirect_chain[0][1], 302)
    ...
    def test_put_method_with_authentication_as_wrong_group(self):
        self.user.groups.add(self.groups['administracja'])
        self.client.force_login(self.user)
        response = self.client.put('/message/new/', follow=True)
        self.assertEqual(response.request['PATH_INFO'], '/')
    ...
    def test_delete_method_without_authentication(self):
        response = self.client.delete('/message/new/', follow=True)
        self.assertEqual(response.request['PATH_INFO'], '/')
        self.assertEqual(len(response.redirect_chain), 1)
        self.assertEqual(response.redirect_chain[0][0], '/?next=/message/new/')
        self.assertEqual(response.redirect_chain[0][1], 302)
    ...
    def test_delete_method_with_authentication_as_wrong_group(self):
        self.user.groups.add(self.groups['administracja'])
        self.client.force_login(self.user)
        response = self.client.delete('/message/new/', follow=True)
        self.assertEqual(response.request['PATH_INFO'], '/')
