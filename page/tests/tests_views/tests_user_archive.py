...
class AdminOrdersTestCase(TestCase):
    ...
    def test_user_archive_put_method_without_authentication(self):
        response = self.client.put('/orders/archive/1/u/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/index.html')
        self.assertEqual(response.templates[1].name, 'page/base.html')
        self.assertEqual(len(response.redirect_chain), 1)
        self.assertEqual(response.redirect_chain[0][0], '/?next=/orders/archive/1/u/')
    ...
    def test_user_archive_put_method_with_authentication(self):
        self.client.force_login(self.user)
        response = self.client.put('/orders/archive/1/u/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/index.html')
        self.assertEqual(response.templates[1].name, 'page/base.html')
    ...
    def test_user_archive_put_method_with_authentication_as_proper_group(self):
        self.user.groups.add(self.groups['druk'])
        self.client.force_login(self.user)
        response = self.client.put('/orders/archive/1/u/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/user_archive.html')
    ...
    def test_user_archive_delete_method_with_authentication(self):
        self.client.force_login(self.user)
        response = self.client.delete('/orders/archive/1/u/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/index.html')
        self.assertEqual(response.templates[1].name, 'page/base.html')
    ...
    def test_user_archive_delete_method_with_authentication_as_proper_group(self):
        self.user.groups.add(self.groups['druk'])
        self.client.force_login(self.user)
        response = self.client.delete('/orders/archive/1/u/', follow=True)
        self.assertEqual(response.templates[0].name, 'page/user_archive.html')
